...
namespace fb_reg
{
    class A30
    {
        ...
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 47.6, 82.0);
        //        Thread.Sleep(300);
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 47.6, 82.0);
        //        Thread.Sleep(1000);
        ...
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 92.3, 30.2);
        //        Thread.Sleep(1000);
        ...
        //        Thread.Sleep(2000);
        //        // Dang ky
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 46.6, 47.3);
        ...
        //            Thread.Sleep(1000);
        //            KAutoHelper.ADBHelper.TapByPercent(deviceID, 57.3, 56.1);
        //            Thread.Sleep(8000);
        //        }
        ...
        //        {
        //            Utility.Log("Have popup1");

        //            KAutoHelper.ADBHelper.TapByPercent(deviceID, 44.9, 57.1);
        //            Thread.Sleep(1000);
        //            // tiep tuc
        //            KAutoHelper.ADBHelper.TapByPercent(deviceID, 50.7, 65.8);
        //            Thread.Sleep(1000);
        //        }
        ...
        //        //    KAutoHelper.ADBHelper.TapByPercent(deviceID, 37.5, 52.8);
        //        //    Thread.Sleep(2000);
        //        //    Utility.Log("Tap text box email address");
        //        //    KAutoHelper.ADBHelper.TapByPercent(deviceID, 19.7, 18.2);
        //        //    KAutoHelper.ADBHelper.TapByPercent(deviceID, 19.7, 18.2);
        ...
        //        //    KAutoHelper.ADBHelper.TapByPercent(deviceID, 51.2, 24.2);
        //        //}
        //        //else
        //        //{
        //        Utility.Log("Check Notnow");
        ...
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 8.0, 24.1);
        //        Thread.Sleep(1000);
        //        Utility.Log("Input code:" + code);
        //        KAutoHelper.ADBHelper.InputText(deviceID, code);

        //        Thread.Sleep(1000);
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 48.8, 29.8);
        //        Thread.Sleep(4000);
        ...
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 74.2, 92.4); //3s
        //        Thread.Sleep(4000);
        //        // Invite your friend
        //        Utility.Log("Invite friend tap");
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 52.8, 92.9);
        //        Thread.Sleep(1000);
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 83.5, 51.9);
        //        Thread.Sleep(3000);
        //        // Save login info
        ...
        //        Thread.Sleep(1000);
        //        // TODO
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 91.5, 23.4);

        //        Thread.Sleep(1000);
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 56.8, 32.4);
        //        Thread.Sleep(3000);
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 19.5, 70);
        //        Thread.Sleep(1000);
        ...
        //        Thread.Sleep(1500);
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 74.7, 13.5);
        //        Thread.Sleep(3000);
        ...
        //    // Ho
        //    KAutoHelper.ADBHelper.TapByPercent(deviceID, 59.5, 29.8);
        //    Thread.Sleep(500);
        //    KAutoHelper.ADBHelper.TapByPercent(deviceID, 59.5, 29.8);
        //    Utility.Log("Text: Ho:" + ho);
        //    string ho1 = Regex.Match(ho, "[\\w]+").ToString();
        ...
        //    if (CheckImage(deviceID, SELECT_YOUR_NAME))
        //    {
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 65.9, 24.0);
        //        Thread.Sleep(1000);
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 51.4, 64.4);
        //        Thread.Sleep(8000);
        //    }
        ...
        //    KAutoHelper.ADBHelper.Swipe(deviceID, 381, baseY, 381, baseY + 300 + randomMonth);
        //    Thread.Sleep(100);
        //    KAutoHelper.ADBHelper.Swipe(deviceID, 537, baseY, 537, baseY + 300 + randomMonth);
        //    Thread.Sleep(100);
        //    KAutoHelper.ADBHelper.Swipe(deviceID, 485, baseY, 485, baseY + 300);
        //    Thread.Sleep(1000);

        //    KAutoHelper.ADBHelper.Swipe(deviceID, 706, baseY, 706, baseY + 300);
        //    Thread.Sleep(100);

        //    KAutoHelper.ADBHelper.Swipe(deviceID, 706, baseY, 706, baseY + 300 + randomYear);
        //    Thread.Sleep(100);
        //    KAutoHelper.ADBHelper.Swipe(deviceID, 706, baseY, 706, baseY + 300 + randomYear);
        //    Thread.Sleep(100);
        //    KAutoHelper.ADBHelper.Swipe(deviceID, 706, baseY, 706, baseY + 300);
        ...
        //    {
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 93.5, 32.0);
        //    }
        //    else
        //    {
        //        KAutoHelper.ADBHelper.TapByPercent(deviceID, 93.2, 37.4);
        //    }
        //}
